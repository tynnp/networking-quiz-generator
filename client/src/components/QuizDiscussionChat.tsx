...
import { Send, ArrowLeft, Users, MessageSquare, ChevronDown, ChevronUp, Quote, HelpCircle } from 'lucide-react';
        ...
        <div className="h-full flex flex-col">
            ...
            <div className="bg-white rounded-lg shadow-md p-4 mb-4">
                <div className="flex items-center gap-2">
                    ...
                    <MessageSquare className="w-6 h-6 text-[#124874]" />
                    <div className="flex-1 min-w-0">
                        <h1 className="text-lg md:text-xl font-bold text-[#124874] truncate">
                            Thảo luận: {quizTitle}
                        </h1>
                        {quiz && (
            ...
            <div className="flex-1 flex gap-4 min-h-0">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-3">
                        {messages.length === 0 ? (
                            <div className="text-center text-gray-500 py-8">
                                ...
                                <p className="text-sm mt-1">Click vào câu hỏi bên phải để trích dẫn và thảo luận!</p>
                            </div>
                        ) : (
                            messages.map((msg) => (
                                <div
                ...
                {/* Right Panel - Questions on top, Online users on bottom */}
                <div className="w-72 flex flex-col gap-4 hidden md:flex">
